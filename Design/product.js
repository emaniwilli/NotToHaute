...
const productImageSlide = document.querySelector(".img-view"); // seclecting image slider element
...
const sizeBtns = document.querySelectorAll('.size-radio'); // selecting size buttons
